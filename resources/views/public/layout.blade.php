...
<style>
:root{--primary:{{ $platformBrand['primary_color'] ?? '#4b2e83' }};--primary-2:{{ $platformBrand['secondary_color'] ?? '#204f78' }};--dark:#24183f;--bg:#f6f7fb;--surface:#fff;--text:#1f2937;--muted:#667085;--border:#e4e7ec;--focus:#ffbf47;--radius:18px;--text-scale:1}*{box-sizing:border-box}html{scroll-behavior:smooth;font-size:calc(16px * var(--text-scale))}body{margin:0;font-family:Inter,Arial,Helvetica,sans-serif;background:var(--bg);color:var(--text);line-height:1.55}body.high-contrast{--bg:#fff;--surface:#fff;--text:#000;--muted:#222;--border:#000;--primary:#24105c}body.grayscale{filter:grayscale(1)}body.dyslexia{font-family:Verdana,Tahoma,sans-serif;letter-spacing:.035em;word-spacing:.08em}body.reduce-motion *,body.reduce-motion *::before,body.reduce-motion *::after{animation:none!important;transition:none!important;scroll-behavior:auto!important}a{text-decoration:none;color:inherit}a:focus-visible,button:focus-visible,input:focus-visible,select:focus-visible,textarea:focus-visible{outline:3px solid var(--focus);outline-offset:3px}.skip-link{position:absolute;left:-9999px;top:auto}.skip-link:focus{left:16px;top:12px;z-index:1000;background:#fff;color:#000;padding:10px 14px;border-radius:10px}.site-header{background:rgba(255,255,255,.97);border-bottom:1px solid var(--border);position:sticky;top:0;z-index:40;backdrop-filter:blur(12px)}.nav{max-width:1180px;margin:auto;padding:13px 20px;display:flex;align-items:center;gap:18px}.brand{font-weight:900;color:var(--primary);display:flex;align-items:center;gap:9px;margin-right:auto;min-width:0}.brand-mark{width:42px;height:42px;min-width:42px;border-radius:12px;display:grid;place-items:center;background:#fff;border:1px solid var(--border);overflow:hidden;color:#fff}.brand-mark.brand-fallback{background:linear-gradient(135deg,var(--primary),var(--primary-2))}.brand-logo{display:block;width:100%;height:100%;object-fit:contain;padding:3px}.brand-name{white-space:nowrap;overflow:hidden;text-overflow:ellipsis;max-width:220px}.nav-links{display:flex;align-items:center;gap:4px;flex-wrap:wrap}.nav-links a{font-size:.9rem;font-weight:800;color:#344054;padding:9px 10px;border-radius:9px}.nav-links a:hover,.nav-links a[aria-current="page"]{background:#f0ebff;color:var(--primary)}.btn{display:inline-flex;align-items:center;justify-content:center;gap:7px;border-radius:11px;padding:10px 14px;font-weight:800;border:1px solid var(--border);background:var(--surface);cursor:pointer;color:var(--text)}.btn-primary{background:linear-gradient(135deg,var(--primary),var(--primary-2));border-color:transparent;color:#fff}.btn-icon{width:42px;height:42px;padding:0}.container{max-width:1180px;margin:auto;padding:28px 20px}.hero{padding:46px 0 24px}.hero h1{font-size:clamp(2rem,5vw,3.4rem);line-height:1.05;margin:0 0 12px;letter-spacing:-.03em}.hero p{color:var(--muted);font-size:1.1rem;max-width:760px}.grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.card{background:var(--surface);border:1px solid var(--border);border-radius:var(--radius);padding:18px;box-shadow:0 10px 28px rgba(31,41,55,.05)}.card h3{margin-top:0}.muted{color:var(--muted)}.filters{display:flex;gap:10px;margin-bottom:18px;flex-wrap:wrap}.filters input,.filters select{flex:1;min-width:200px;border:1px solid #d0d5dd;border-radius:11px;padding:12px;background:var(--surface);color:var(--text)}.badge{display:inline-flex;border-radius:999px;padding:4px 9px;background:#ede9fe;color:var(--primary);font-size:.75rem;font-weight:900}.pagination{margin-top:20px}.auth-actions{display:flex;gap:8px;align-items:center}.footer{margin-top:50px;background:var(--dark);color:#fff}.footer-inner{max-width:1180px;margin:auto;padding:30px 20px;display:flex;justify-content:space-between;gap:20px;flex-wrap:wrap}.footer-brand{display:flex;align-items:center;gap:12px}.footer-logo{width:48px;height:48px;object-fit:contain;background:#fff;border-radius:12px;padding:3px}.flash{padding:12px 14px;border-radius:10px;margin-bottom:16px;background:#ecfdf5;border:1px solid #bbf7d0;color:#166534}.floating-tools{position:fixed;right:18px;bottom:18px;display:flex;flex-direction:column;gap:10px;z-index:60}.float-btn{width:52px;height:52px;border:0;border-radius:16px;display:grid;place-items:center;background:var(--surface);color:var(--primary);box-shadow:0 12px 28px rgba(0,0,0,.16);font-size:1.2rem;cursor:pointer}.float-btn.chat{background:linear-gradient(135deg,var(--primary),var(--primary-2));color:#fff}.panel{position:fixed;right:18px;bottom:86px;width:min(380px,calc(100vw - 32px));max-height:72vh;background:var(--surface);border:1px solid var(--border);border-radius:20px;box-shadow:0 24px 60px rgba(0,0,0,.2);z-index:70;display:none;overflow:hidden}.panel.open{display:flex;flex-direction:column}.panel-head{display:flex;align-items:center;gap:10px;padding:14px 16px;border-bottom:1px solid var(--border)}.panel-head strong{flex:1}.panel-body{padding:14px;overflow:auto}.access-row{display:flex;justify-content:space-between;gap:12px;align-items:center;padding:10px 0;border-bottom:1px solid var(--border)}.switch{display:flex;gap:8px}.chat-messages{display:flex;flex-direction:column;gap:10px;min-height:190px;max-height:360px;overflow:auto}.msg{max-width:88%;padding:10px 12px;border-radius:14px;background:#f2f4f7}.msg.user{align-self:flex-end;background:#ede9fe}.chat-quick{display:flex;gap:7px;flex-wrap:wrap;margin:12px 0}.chat-quick button{border:1px solid var(--border);background:var(--surface);border-radius:999px;padding:7px 10px;font-weight:700;cursor:pointer}.chat-form{display:flex;gap:8px;border-top:1px solid var(--border);padding:12px}.chat-form input{flex:1;border:1px solid #d0d5dd;border-radius:11px;padding:11px}.sr-only{position:absolute;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}@media(max-width:900px){.nav{align-items:flex-start;flex-wrap:wrap}.nav-links{order:3;width:100%;overflow:auto;white-space:nowrap;flex-wrap:nowrap}.grid{grid-template-columns:1fr 1fr}.brand-name{max-width:180px}}@media(max-width:640px){.grid{grid-template-columns:1fr}.auth-actions .muted{display:none}.auth-actions{width:auto}.container{padding:22px 16px}.floating-tools{right:12px;bottom:12px}.panel{right:12px;bottom:76px}.nav{padding-inline:14px}.brand-mark{width:38px;height:38px;min-width:38px}.brand-name{max-width:145px;font-size:.9rem}}
</style>
</head>
<body>

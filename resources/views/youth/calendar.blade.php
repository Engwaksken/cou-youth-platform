...
<button class="tab active" data-tab="events" type="button"><i class="fas fa-calendar-days"></i> Events <span>{{ $events->count() }}</span></button>
<button class="tab" data-tab="services" type="button"><i class="fas fa-video"></i> Online Services <span>{{ $services->count() }}</span></button>
</div>
<section class="tab-panel active" id="tab-events">
